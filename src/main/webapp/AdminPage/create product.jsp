                ...
                <div class="page-content">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <hr />
                            <form class="form-body mt-4" action="CreateServlet" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="border border-3 p-4 rounded">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="inputProductTitle"
                                                       placeholder="Enter product title" name="name" value="${param.name}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="inputProductDescription" class="form-label">Description</label>
                                                <textarea class="form-control" id="inputProductDescription"
                                                          rows="3" name="description">${param.description}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <div class="center">
                                                    <div class="form-input">
                                                        <div
                                                            ...
                                                            <img id="file-ip-1-preview" src="#" alt="your image">
                                                        </div>          
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" id="inputPrice" min="1"
                                                           max="999" maxlength="3" placeholder="000" name="price" value="${param.price}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="inputCompareatprice" class="form-label">Satus</label>
                                                    <select name="status" class="form-control">
                                                        <option value="true" ${param.status eq 'true' ? 'selected':''} >True</option>
                                                        <option value="false" ${param.status eq 'false' ? 'selected':''} >False</option>
                                                    </select>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <select class="form-select" id="inputProductType" name="categoryId">                               
                                                        <c:forEach var="category" items="${requestScope.LIST_CATEGORIES}" >
                                                            <option value="${category.categoryId}" ${(param.categoryId eq category.categoryId) ? 'selected':''} >${category.name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                                <div class="col-12">
