<%-- 
    Document   : header
    Created on : Aug 13, 2023, 6:34:25 PM
    Author     : DELL
--%>
...
<!--start header -->
<header>
    <c:set var="account" value="${sessionScope.LOGINED_USER}" />
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                   role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="AdminPage/assets/images/avatars/avatar-2.png" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">${account.userName}</p>
                        <p class="designattion mb-0">Manage Store</p>
                    </div>
                </a>
