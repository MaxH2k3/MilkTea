        ...
        try {
            ...
            if (user == null) {
                ...
                if (cookies != null) {
                    ...
                    //5. call Model - DAO and user checkLogin
                ...
                }// end cookies have been not exsited
            }
            //The SiteMaps to get URL Pattern
            url = (String) siteMaps.get(resource);
