...
public class UpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = (String) siteMaps.get(MyAppConstants.CRUDFeatureProduct.UPDATE_PAGE);

        String producIdStr = request.getParameter("productId");
        ...
        if (validator.hasError()) {
            ...
            try {
                int productId = Integer.parseInt(producIdStr);
                ...
                boolean result = dao.update(new ProductDTO(productId, productName, price, description, "", status, categoryId), image);
                if (result) {
