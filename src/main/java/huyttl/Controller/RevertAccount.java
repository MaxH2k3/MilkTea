 ...
 * @author DELL
 */
public class RevertAccount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            boolean result = dao.revertAccount(userId);
            
            if(result) {
                request.setAttribute("NOTIFICATION", new Notification("REVERT ACCOUNT SUCCESFULL", true));
            }  else {
